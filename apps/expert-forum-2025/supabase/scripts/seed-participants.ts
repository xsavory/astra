...
const PARTICIPANTS_DATA: ParticipantData[] = [
  ...
  // {
  //   name: 'Cucup Supriadi',
  //   email: 'cucup.supriadi@astra.com',
  //   participant_type: 'offline',
  //   company: 'Astra Daihatsu Motor',
  //   division: 'Digital',
  // },
  // {
  //   name: 'Bayu Hermawan',
  //   email: 'bayu.hermawan@astra.com',
  //   participant_type: 'offline',
  //   company: 'Astra Graphia',
  //   division: 'Engineering',
  // },
  // {
  //   name: 'Sahli Mahfudi',
  //   email: 'sahli.mahfudi@astra.com',
  //   participant_type: 'offline',
  ...
  // },
  // {
  //   name: 'Firdani Apriana',
  //   email: 'firdani.apriana@ai.astra.co.id',
  //   participant_type: 'offline',
  //   company: 'Astra Otoparts',
  //   division: 'Operation',
  // },
  // {
  //   name: 'Ghifari Arifin',
  //   email: 'ghifari.arifin@ai.astra.co.id',
  //   participant_type: 'offline',
  //   company: 'Astra Financial',
  //   division: 'Finance',
  // },
  // {
  //   name: 'Euis Dina Handayani',
  //   email: 'euis.dinahandayani@ai.astra.co.id',
  //   participant_type: 'offline',
  //   company: 'Astra Financial',
  //   division: 'Marketing',
  // },
  // {
  //   name: 'Rachmat Mujianto',
  //   email: 'rachmat.mujianto@ai.astra.co.id',
  //   participant_type: 'offline',
  //   company: 'Astra Daihatsu Motor',
  ...
  // {
  //   name: 'Esther Akwila',
  //   email: 'esther.akwila@ai.astra.co.id',
  //   participant_type: 'online',
  //   company: 'Astra Honda Motor',
  //   division: 'Digital',
  // },
  // {
  //   name: 'Bening Swarajiwa',
  //   email: 'bening.swarajiwa@ai.astra.co.id',
  //   participant_type: 'online',
  //   company: 'Astra Honda Motor',
  //   division: 'Digital',
  // },
  {
    name: 'Rachmat Mujianto 2',
    email: 'rachmat.mujianto2@ai.astra.co.id',
    participant_type: 'online',
    company: 'Astra Daihatsu Motor',
    division: 'Information Technology',
  },
